...
=item ability to handle circular data
...
no having to reallocate and move the entire structure as it grows and shrinks
...
The result will still be an array - this may be important if you will be doing
a lot of random access into the array.
...
count reaches C<0>, the object is garbage collected.  Simples!

Indeed, for simple cases, this works perfectly.  With a singly linked list, for
example:
